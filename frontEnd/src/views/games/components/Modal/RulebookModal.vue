...
const leftPages = [
  [
    ...
    "음유시인<br><br>모험가의 인생은 탁 트인 길과 부귀영화, 그리고 모험뿐이라고, 노래와 시에서는 말합니다. 술집이면 술집마다, 여관이면 여관마다 울려 퍼지는 노래들이 설마 처음부터 끝까지 꾸며낸 소리겠습니까? 평민의 가슴과 왕족의 가슴을 가리지 않고 설레게 하는 노래들, 야수의 마음을 달래고 사람의 투지를 불태우는 노래들의 출처는 과연 어디겠습니까?<br><br>그게 부드러운 혀와 날카로운 재치의 음유시인, 노래와 이야기에 사는 자, 바로 당신입니다. 평범한 노래꾼은 들은 노래를 부르고 왼 이야기를 되풀이할 뿐이지만, 진정한 음유시인은 노래 같은 삶을 삽니다. 그러니 장화끈을 매고 단도의 날을 가십시오. 영웅들 틈에서 싸우며 영웅이 되어야 비로소 그런 노래를 지을 자격도 생기는 법입니다.<br><br>동료들이 당신의 노래를 기다립니다. 이제 출발할 시간입니다."
  ],
  [
...
const rightPages = [
  [
    "목차<br><br>1. 기본 소개<br>2. 게임의 기본<br>3. 직업과 역할<br>4. 게임 시스템<br>5. 게임 환경<br>6. 게임 진행<br>7. 부록 및 추가 정보",
    ...
    "드루이드<br><br>모닥불 주위를 둘러 보십시오. 도시의 홍진에 뒤덮이고 땀 냄새가 진동하는 이 사람들 곁에 당신이 머무르는 이유는 무엇입니까? 마치 새끼곰들을 보살피는 어미곰처럼 친절하기 때문입니까? 그렇다면 이제 저 사람들도 당신과 한 무리인가요? 참으로 기묘한 형제자매를 두셨습니다. 이유가 무엇이건 간에, 당신의 날카로운 발톱, 그리고 그보다 날카로운 감각이 없으면 저들은 이곳에서 살아남지 못할 것입니다.<br><br>당신은 신성한 대지의 자녀입니다. 흙에서 태어나, 그 정령의 자국을 피부에 새겼습니다. 전에는 아니었을 수도 있습니다. 심지어 한때는 저들처럼 도시에서 살았을 수도 있습니다. 그러나 과거는 과거일 뿐입니다. 당신은 이제 그 형태조차 자유롭습니다.<br><br>당신 친구들은 돌을 깎아 만든 신들에게 기도하며 쇳조각에 윤을 냅니다. 자기들이 살던 그 악취 나는 도시로 돌아가면 영광이 기다릴 것이라고 합니다.",
...
.nav-button.prev {
  left: 2%; /* 왼쪽 가장자리에서 고정된 거리 */
}

.nav-button.next {
  right: 3%; /* 오른쪽 가장자리에서 고정된 거리 */
}
